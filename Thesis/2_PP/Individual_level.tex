...
While the implementation of species specific reaction norms allows contrasted responses, these plastic responses need to make sense in an ecological perspective. In other word, the alternative changes in phenotype need to lead to a greater (or more stable) fitness.
