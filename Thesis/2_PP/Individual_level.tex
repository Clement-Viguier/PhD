...
%
%Why ? trade-off too strong of tissues, but not enough of root:shoot ratio? Why ? mean organ approach: effect on already produced tissues, lack reactivity and amplitude,
...
%The roles of PA and RMF? balance versus efficiency. Because of the same variability of RMF.
...
%grassein (similar response: lower leaf density when water treatment 
%+ Liu
...
%
%Where is the optimum ?  what makes an optimum ? Why is it important ? -- better understand how plasticity works and can improve plant performance.
%
...
\section{Other plasticity patterns, alternative implementations and stability of results}
