...
%restrict y to domain=-300:700,
xlabel = $I (W.cm^{2})$,
ylabel = $P_{leaf} (gCO_{2}.cm^{-2}s^{-1})$
%extra x ticks={0.618},
%extra x tick style={grid=major}
]
...
\subsection{Link to real world and data}
