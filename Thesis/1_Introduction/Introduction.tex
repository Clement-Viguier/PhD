...
\section{The question of coexistence}
...
% _______________________________________________________________________________________
\section{The complexity of community dynamics}
...
Jung: not always in the same way \cite{jung_intraspecific_2014}\\
\cite{kichenin_contrasting_2013}
\cite{siefert_global_2015}
\cite{albert_importance_2012}
\cite{violle_return_2012}

\paragraph{...and contrasting effects}

\cite{hart_how_2016}
\cite{courbaud_intra-specific_2010}
\cite{turcotte_phenotypic_2016}
\cite{roscher_contrasting_2015}
\cite{valladares_species_2015}
\cite{barabas_effect_2016}
\cite{jung_intraspecific_2010}
...
% _______________________________________________________________________________________
\section{Beyond the mean and the bell-shape: towards more mechanisms in representing intra-specific variability}
...
What are the possible effects? probably it does not affect interaction like \cite{hart_how_2016} supposes (even if they talk about variations, their conclusions may not be extendable to plastic variations). May change a lot the balance between abiotic filtering and biotic filtering. 
